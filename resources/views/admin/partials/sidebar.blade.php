      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li class="cursor-pointer">
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ request()->routeIs('admin.dashboard')?'bg-graydark dark:bg-meta-4':'' }}"
            ...
            >
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white {{ request()->routeIs('admin.dashboard') ? 'text-white':'' }}"
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ request()->routeIs('admin.features.index')?'bg-graydark dark:bg-meta-4':'' }}"
              href="#"
              @click.prevent="selected = (selected === 'Package' ? '':'Package')"
              :class="{ '': (selected === 'Package') || (page === 'Features' || page === 'Create Package') }"
            >
              <svg
                class="fill-current"
                width="18"
              ...
              <svg
                class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                :class="{ 'rotate-180': (selected === 'Package') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              class="translate transform overflow-hidden"
              :class="(selected === 'Package') ? 'block' :'hidden'"
            >
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white {{ request()->routeIs('admin.features.index')?'text-white':'text-bodydark2' }}"
                    href="{{ route('admin.features.index') }}"
                    {{-- :class="page === 'package_feature' && '!text-white'" --}}
                    >Package Features
                  </a>
                </li>
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white {{ request()->routeIs('admin.packages.index')?'text-white':'text-bodydark2' }}"
                    href="{{ route('admin.packages.index') }}"
                    {{-- :class="page === 'create' && '!text-white'" --}}
                    >Create Package
                  </a>
                </li>
              </ul>
